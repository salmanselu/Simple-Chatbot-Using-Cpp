  ...
  while (1)
  {
    ...
    else if (!strcmp(s, "what is your name?") || !strcmp(s, "tell me your name"))
    {
      ...
      case 1:
        ...
        break;
      case 2:
        cout << "my name is CB-3";
        break;
      case 3:
        cout << "I am a computer program and my name is CB-3";
        break;
      case 4:
        cout << "CB-3 is my name";
        break;
      case 5:
        cout << "I have been given the name CB-3";
        break;
      case 6:
        cout << "hello I am CB-3";
        break;
      case 7:
        cout << "hi. My name is CB-3";
        break;
      }
    }
    else if (!strcmp(s, "tell me more about yourself") || !strcmp(s, "tell me about yourself") || !strcmp(s, "tell me more about you") || !strcmp(s, "who are you?") || !strcmp(s, "what are you?"))
    {
      ...
      case 1:
        ...
        break;
      case 2:
        cout << "I am a simple chat bot coded by Salman Nazeer on his computer.";
        break;
      case 3:
        cout << "I am a simple program code that can talk";
        break;
      case 4:
        cout << "I am a simple program code that can talk and I was created by Salman Nazeer";
        break;
      case 5:
        cout << "I am a simple program code that can talk and my name is CB-3";
        break;
      case 6:
